...
exports.smsg = (conn, m, store) => {
    ...
    if (m.message) {
        ...
        // Safely extract body with proper checks
        m.body = m.message.conversation || 
                (m.msg && m.msg.text) || 
                (m.msg && m.msg.caption) || 
                (m.mtype == 'imageMessage' && m.message.imageMessage && m.message.imageMessage.caption) || 
                (m.mtype == 'videoMessage' && m.message.videoMessage && m.message.videoMessage.caption) || 
                (m.mtype == 'extendedTextMessage' && m.message.extendedTextMessage && m.message.extendedTextMessage.text) || 
        ...
        if (m.quoted) {
            ...
            m.quoted.text = m.quoted.text || 
                           ...
                           (m.quoted && m.quoted.contentText) || 
                           (m.quoted && m.quoted.selectedDisplayText) || 
                           (m.quoted && m.quoted.title) || '';
            m.quoted.mentionedJid = m.msg.contextInfo ? m.msg.contextInfo.mentionedJid : [];

            // Add quoted message utilities
            m.getQuotedObj = m.getQuotedMessage = async () => {
                if (!m.quoted.id) return false;
                let q = await store.loadMessage(m.chat, m.quoted.id, conn);
                return q ? exports.smsg(conn, q, store) : false;
            };
